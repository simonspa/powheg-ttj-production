...
do
  ...
  sed -e "s/##JOBNUMBER##/${paddedjob}/g" -e "s/##MASS##/${mass}/g" -e "s/##TOPMASS##/${topmass}/g" -e "s/##RUNNAME##/${run}/g" < /nfs/dust/cms/user/spanns/montecarlo-generation/hadronization/config/Hadronizer_Tune4C_emissionVeto1_LHE_pythia8_nopThard.py-tmpl > Hadronizer_Tune4C_emissionVeto1_LHE_pythia8-${paddedjob}.py
